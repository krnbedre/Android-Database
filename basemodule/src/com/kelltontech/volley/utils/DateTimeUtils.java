...
public class DateTimeUtils {
    ...
    public interface Format {
        ...
        String DD = "dd";
        String MMM_DD_YYYY_at_hh_mm_a = "MMM dd, yyyy 'at' hh:mm a";
        String MMM = "MMM";
        String Dow = "E";
        String Mmmm_YYYY = "MMMM yyyy";
        String MMM_DD_YYYY_at_hh_a = "MMM dd, yyyy 'at' hh:00 a";
        String MMM_DD_YYYY_at_hh_mm_ss_a = "MMM dd, yyyy hh:mm:ss a";
        String MMMM_dd_yyyy_hh_a = "MMMM dd, yyyy '@' hh:00 a";
