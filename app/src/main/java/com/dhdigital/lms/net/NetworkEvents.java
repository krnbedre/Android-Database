...
/**
 * Created by Kiran Bedre on 9/11/15.
 * DarkHorse BOA
 */
public class NetworkEvents {
     ...
     */
    public static final int VALIDATE_USER = 300;
    public static final int INVALIDATE_USER = 301;

    public static final int GET_MASTER_DATA_LEAVE_ENTITLEMENT = 302;
    public static final int GET_MASTER_DATA_LEAVE_TYPE = 303;
    ...
    public static final int MY_LEAVES_REQUEST = 308;
    public static final int MY_LEAVES_BALANCE = 309;
